...
img=PhotoImage(file="../assets/images/prof.png")
...
#les image
img1 = PhotoImage(file="../assets/images/add_client.png")
img2 = PhotoImage(file="../assets/images/find_client.png")
img3 = PhotoImage(file="../assets/images/display_client.png")
img4 = PhotoImage(file="../assets/images/delete_client.png")
img5 = PhotoImage(file="../assets/images/modify_client.png")
img6 = PhotoImage(file="../assets/images/delet_tout.png")
image=PhotoImage(file="../assets/images/icoprof.png")
